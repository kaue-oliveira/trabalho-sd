...
INSERT INTO analises (usuario_id, tipo_cafe, data_colheita, quantidade, cidade, estado, estado_cafe, data_analise, decisao, explicacao_decisao) VALUES
    ...
    (1, 'Arábica', '2024-04-20', 800.75, 'Varginha', 'MG', 'verde', '2024-05-10', 'VENDER', 'Café Bourbon com nota excelente (86), mas preço pode subir com chegada do inverno. Vender 60% agora e aguardar valorização do restante.'),
    (1, 'Robusta', '2024-03-10', 1200.00, 'Varginha', 'MG', 'verde', '2024-04-05', 'AGUARDAR', 'Mercado saturado de Catuaí neste período. Preços abaixo da média. Condições climáticas estáveis permitem armazenamento por mais 30 dias.'),
    ...
    (1, 'Robusta', '2024-02-15', 1800.00, 'Varginha', 'MG', 'verde', '2024-03-10', 'VENDER', 'Grande volume disponível. Vender 40% para capital rápido e aguardar contratos de exportação que fecham em 3 semanas.'),
    (1, 'Robusta', '2024-01-20', 750.50, 'Varginha', 'MG', 'moído', '2024-02-15', 'VENDER', 'Produto moído tem alta rotatividade. Preço está 15% acima da média sazonal. Vender todo estoque para evitar perda de aroma.')
ON CONFLICT (id) DO NOTHING;

-- Análises para Cooperativa Café Mineiro
INSERT INTO analises (usuario_id, tipo_cafe, data_colheita, quantidade, cidade, estado, estado_cafe, data_analise, decisao, explicacao_decisao) VALUES
    (2, 'Arábica', '2024-03-10', 3000.00, 'Linhares', 'ES', 'verde', '2024-04-05', 'AGUARDAR', 'Mercado de Conilon em baixa. Previsão de geada no Paraná pode elevar preços nas próximas semanas. Condições de armazenamento adequadas.'),
